...
export CONSUL_LOG_ROTATE_MAX_FILES="${CONSUL_LOG_ROTATE_MAX_FILES:-5}"
export CONSUL_LOG_ROTATE_DURATION="${CONSUL_LOG_ROTATE_DURATION:-24h}"
export CONSUL_LOG_ROTATE_BYTES="${CONSUL_LOG_ROTATE_BYTES:-100000000}"
EOF
